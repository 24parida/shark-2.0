...
LIBDIVIDE_API struct libdivide_s32_branchfree_t
libdivide_s32_branchfree_gen(int32_t y);
LIBDIVIDE_API struct libdivide_u32_branchfree_t
libdivide_u32_branchfree_gen(uint32_t y);
LIBDIVIDE_API struct libdivide_s64_branchfree_t
libdivide_s64_branchfree_gen(int64_t y);
LIBDIVIDE_API struct libdivide_u64_branchfree_t
libdivide_u64_branchfree_gen(uint64_t y);
...
LIBDIVIDE_API int
libdivide_u32_get_algorithm(const struct libdivide_u32_t *denom);
LIBDIVIDE_API uint32_t
...
LIBDIVIDE_API int
libdivide_u64_get_algorithm(const struct libdivide_u64_t *denom);
LIBDIVIDE_API uint64_t
...
LIBDIVIDE_API int
libdivide_s32_get_algorithm(const struct libdivide_s32_t *denom);
LIBDIVIDE_API int32_t
...
LIBDIVIDE_API int
libdivide_s64_get_algorithm(const struct libdivide_s64_t *denom);
LIBDIVIDE_API int64_t
...
__m128i libdivide_s32_do_vector_alg4(__m128i numers,
  ...
  __m128i q =
      libdivide_mullhi_s32_flat_vector(numers, _mm_set1_epi32(denom->magic));
  q = _mm_sra_epi32(
      q, libdivide_u32_to_m128i(more & LIBDIVIDE_32_SHIFT_MASK)); // q >>= shift
  q = _mm_add_epi32(q, _mm_srli_epi32(q, 31)); // q += (q < 0)
  return q;
}
...
__m128i libdivide_s32_branchfree_do_vector(
  ...
  q = _mm_add_epi32(
      q, _mm_and_si128(q_sign, _mm_set1_epi32(
                                   (1 << shift) -
...
__m128i libdivide_s64_branchfree_do_vector(
  ...
  q = _mm_add_epi64(
      q, _mm_and_si128(q_sign, libdivide__u64_to_m128(
                                   (1ULL << shift) -
                                   is_power_of_2))); // q = q + (q_sign & ((1 <<
                                                     // shift) - is_power_of_2)
...
template <typename T, int ALGO = BRANCHFULL> class divider {
private:
